  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <ul
          className={`lg:flex lg:space-x-8 text-lg absolute lg:relative bg-gray-900 w-full lg:w-auto top-16 left-0 lg:top-0 transition-all duration-300 ease-in-out ${
        ...
        >
          ...
          <li>
            ...
            >
              <FaInfoCircle className="inline-block mr-2" /> {/* About Icon */}
            </Link>
          </li>
        </ul>
        ...
        <button
          ...
          className="lg:block bg-gray-800 text-white p-2 rounded-full transition-all duration-300 focus:outline-none hover:bg-gray-700"
        >
